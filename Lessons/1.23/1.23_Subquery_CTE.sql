...
-- Show each job's salary next to the overall market median salary:
SELECT 
    job_title_short,
    salary_year_avg,
    (
...
-- Keep only jobs titles whose median salary is above the overall median:
SELECT 
    job_title_short,
    salary_year_avg,
    (
...
-- CTE Example
-- Compare how much more (or less) remote roles pay compared to on site roles for each job title.
-- Use a CTE tocalculate the median salary by title and work arrangement, then compare those medians.
